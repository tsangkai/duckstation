  ...
  : QWidget(parent), m_host_interface(host_interface)
{
  ...
  dialog->registerWidgetHelp(m_ui.cropMode, "Crop Mode", "Only Overscan Area",
  ...
  dialog->registerWidgetHelp(m_ui.forceProgressiveScan, "Force Progressive Scan", "Checked",
