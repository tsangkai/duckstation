...
static std::array<const char*, 5> s_display_aspect_ratio_names = {{"4:3", "16:9", "2:1 (VRAM 1:1)", "1:1", "1:1 PAR"}};
static constexpr std::array<float, 5> s_display_aspect_ratio_values = {{4.0f / 3.0f, 16.0f / 9.0f, 2.0f / 1.0f, 1.0f, -1.0f}};
