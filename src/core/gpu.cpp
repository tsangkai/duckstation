...
void GPU::UpdateCRTCDisplayParameters()
{
  ...
  cs.display_width = (((cs.horizontal_active_end - cs.horizontal_active_start) / cs.dot_clock_divider) + 3u) & ~3u;
  ...
  cs.display_vram_width = ((horizontal_active_ticks / cs.dot_clock_divider) + 3u) & ~3u;
